...
export default function ProfileLayout({ children }) {
  ...
  return (
    <section className="flex items-center md:p-24 max-h-screen absolute top-8 left-0 right-0 bottom-0 bg-white/60 backdrop-blur-lg">
      <div className="grow h-full justify-center  bg-gray-50 rounded-lg border border-gray-300 shadow-md">
        ...
        <div className="flex flex-row">
          <nav className="flex flex-col items-center lg:w-1/5 px-8 py-14 ">
            <ul>
              {!currentUser &&
          ...
          <main className="grow pl-20 p-6">{children}</main>
        </div>
      </div>
    </section>
  );
